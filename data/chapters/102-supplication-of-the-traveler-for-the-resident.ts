    ...
    duas: [
      {
        ...
        sync: [
          { text: "أَسْتَوْدِعُكُمُ", trans: { ru: "Отдаю вас под защиту", en: "I entrust you to" }, start: 0.35, end: 1.46 },
          ...
          { text: "وَدَائِعُهُ", trans: { ru: "отданное Ему на хранение", en: "His trusts" }, start: 4.46, end: 5.66 }
        ],
