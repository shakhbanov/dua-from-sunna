...
export const CHAPTER_127: ChapterData = {
    id: 127,
    title: { ru: "Что желательно говорить человеку, который боится что-нибудь сглазить", en: "What to say when you fear you might afflict something with the evil eye" },
    duas: [
      {
        id: "127-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/dua.shakhbanov.org/dua-from-sunna/239.mp3?v=f3108f4f",
        narration: {
        ...
        fullTranslation: {
          ru: "О Аллах, благослови это!",
          en: "O Allah, bless it."
        },
        sync: [
          { text: "اللَّهُمَّ", trans: { ru: "О Аллах", en: "O Allah" }, start: 0.41, end: 1.68 },
          { text: "بَارِكْ", trans: { ru: "благослови", en: "bless" }, start: 1.68, end: 3.27 },
          { text: "عَلَيْهِ", trans: { ru: "это", en: "it" }, start: 3.45, end: 4.68 }
        ],
