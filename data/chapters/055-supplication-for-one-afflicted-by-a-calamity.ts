...
export const CHAPTER_055: ChapterData = {
    ...
    duas: [
      {
        id: "55-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/dua.shakhbanov.org/dua-from-sunna/154.mp3?v=095ac1ee",
        fullTranslation: {
        ...
        sync: [
          { text: "إِنَّا", trans: { ru: "Поистине, мы", en: "Truly we" }, start: 0.41, end: 1.66 },
          { text: "لِلَّهِ", trans: { ru: "Аллаху", en: "belong to Allah" }, start: 1.66, end: 3.13 },
          { text: "وَإِنَّا", trans: { ru: "и поистине мы", en: "and truly we" }, start: 3.13, end: 4.83 },
          { text: "إِلَيْهِ", trans: { ru: "к Нему", en: "to Him" }, start: 4.83, end: 6.14 },
          { text: "رَاجِعُونَ", trans: { ru: "возвращающиеся", en: "shall return" }, start: 6.14, end: 8.88 },
          { text: "۝ ١٥٦", trans: { ru: "", en: "" }, start: 10.36, end: 12.5, isVerseEnd: true },
