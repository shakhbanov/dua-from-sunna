...
export const CHAPTER_053: ChapterData = {
    ...
    duas: [
      {
        id: "53-1",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/150.wav",
        fullTranslation: {
        ...
        sync: [
          ...
          { text: "بِالرَّفِيقِ", trans: { ru: "к обществу", en: "with the companionship" }, start: 0, end: 0 },
          { text: "الْأَعْلَىٰ", trans: { ru: "высшему", en: "of the Highest" }, start: 0, end: 0 }
        ],
        note: {
      ...
      {
        id: "53-2",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/151.wav",
        narration: {
      ...
      {
        id: "53-3",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/152.wav",
        fullTranslation: {
