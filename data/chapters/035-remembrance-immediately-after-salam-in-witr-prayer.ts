...
export const CHAPTER_035: ChapterData = {
    id: 35,
    title: { ru: "Слова поминания Аллаха, которые произносятся после завершения витра и приветствия (таслим)", en: "Remembrance immediately after Salam in Witr prayer" },
    duas: [
      {
        id: "35-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/119.wav",
        fullTranslation: {
        ...
        sync: [
          ...
          { text: "الْمَلِكِ", trans: { ru: "Царь", en: "the King" }, start: 0, end: 0 },
          { text: "الْقُدُّوسِ", trans: { ru: "Пресвятой", en: "the All-Holy" }, start: 0, end: 0 },
          { text: "رَبِّ", trans: { ru: "Господь", en: "Lord of" }, start: 0, end: 0 },
