...
export const CHAPTER_123: ChapterData = {
    ...
    duas: [
      {
        id: "123-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/dua.shakhbanov.org/dua-from-sunna/234.mp3?v=67e11495",
        narration: {
        ...
        sync: [
          { text: "اللَّهُ", trans: { ru: "Аллах", en: "Allah" }, start: 0.28, end: 0.79 },
          { text: "أَكْبَرُ", trans: { ru: "велик", en: "(is) greatest" }, start: 0.79, end: 2.72 }
        ],
        note: {
