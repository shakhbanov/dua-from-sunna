    ...
    duas: [
      {
        ...
        sync: [
          ...
          { text: "فِي", trans: { ru: "в", en: "in" }, start: 3.21, end: 3.6 },
          { text: "الدُّنْيَا", trans: { ru: "мире этом", en: "this world" }, start: 3.72, end: 4.8 },
          { text: "حَسَنَةً", trans: { ru: "благо", en: "good" }, start: 4.8, end: 6.17 },
          { text: "وَفِي", trans: { ru: "и в", en: "and in" }, start: 6.28, end: 7.63 },
          { text: "الْآخِرَةِ", trans: { ru: "мире ином", en: "the Hereafter" }, start: 7.76, end: 9.15 },
