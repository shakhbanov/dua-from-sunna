...
export const CHAPTER_119: ChapterData = {
    id: 119,
    title: { ru: "Слова мольбы между йеменским углом Каабы и Черным камнем", en: "Supplication between the Yemeni Corner and the Black Stone" },
    duas: [
      {
        id: "119-1",
        ...
        sync: [
          { text: "رَبَّنَا", trans: { ru: "Господь наш", en: "Our Lord" }, start: 0.21, end: 1.23 },
          ...
          { text: "حَسَنَةً", trans: { ru: "благо", en: "good" }, start: 4.87, end: 6.29 },
          { text: "وَفِي", trans: { ru: "и в", en: "and in" }, start: 6.29, end: 7.83 },
          { text: "الْآخِرَةِ", trans: { ru: "мире ином", en: "the Hereafter" }, start: 7.83, end: 9.41 },
          { text: "حَسَنَةً", trans: { ru: "благо", en: "good" }, start: 9.41, end: 10.61 },
          { text: "وَقِنَا", trans: { ru: "и защити нас", en: "and protect us" }, start: 10.61, end: 12.33 },
          { text: "عَذَابَ", trans: { ru: "от мук", en: "(from the) punishment" }, start: 12.33, end: 13.55 },
          { text: "النَّارِ", trans: { ru: "Огня", en: "(of) the Fire" }, start: 13.55, end: 16.37 }
        ],
