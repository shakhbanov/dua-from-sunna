...
export const CHAPTER_047: ChapterData = {
    ...
    duas: [
      {
        id: "47-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/141.wav",
        narration: {
      ...
      {
        id: "47-2",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/142.wav",
        narration: {
        ...
        sync: [
          ...
          { text: "حَيَّ", trans: { ru: "Спешите", en: "Come" }, start: 0, end: 0 },
          { text: "عَلَى", trans: { ru: "на", en: "to" }, start: 0, end: 0 },
          { text: "الصَّلَاةِ", trans: { ru: "молитву", en: "prayer" }, start: 0, end: 0 },
          { text: "حَيَّ", trans: { ru: "Спешите", en: "Come" }, start: 0, end: 0 },
      ...
      {
        id: "47-3",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/143.wav",
        narration: {
