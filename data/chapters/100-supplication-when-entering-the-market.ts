...
export const CHAPTER_100: ChapterData = {
    ...
    duas: [
      {
        id: "100-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/210.wav",
        narration: {
        ...
        sync: [
          ...
          { text: "يُحْيِي", trans: { ru: "Он оживляет", en: "He gives life" }, start: 0, end: 0 },
          { text: "وَيُمِيتُ", trans: { ru: "и умерщвляет", en: "and causes death" }, start: 0, end: 0 },
          { text: "وَهُوَ", trans: { ru: "и Он", en: "and He" }, start: 0, end: 0 },
          { text: "حَيٌّ", trans: { ru: "Живой", en: "(is) ever-living" }, start: 0, end: 0 },
          { text: "لَا", trans: { ru: "не", en: "not" }, start: 0, end: 0 },
          { text: "يَمُوتُ", trans: { ru: "умирает", en: "dying" }, start: 0, end: 0 },
          { text: "بِيَدِهِ", trans: { ru: "в Его руке", en: "in His hand" }, start: 0, end: 0 },
          { text: "الْخَيْرُ", trans: { ru: "благо", en: "(is) the good" }, start: 0, end: 0 },
          { text: "وَهُوَ", trans: { ru: "и Он", en: "and He" }, start: 0, end: 0 },
