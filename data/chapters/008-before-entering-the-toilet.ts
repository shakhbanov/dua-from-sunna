    ...
    duas: [
      {
        ...
        sync: [
          { text: "بِسْمِ", trans: { ru: "С именем", en: "In the name of" }, start: 0.28, end: 1.06 },
          { text: "اللَّهِ", trans: { ru: "Аллаха", en: "Allah" }, start: 1.06, end: 1.93 },
          { text: "اللَّهُمَّ", trans: { ru: "О Аллах", en: "O Allah" }, start: 3.17, end: 4.15 },
          { text: "إِنِّي", trans: { ru: "поистине я", en: "verily I" }, start: 4.15, end: 5.4 },
          { text: "أَعُوذُ", trans: { ru: "прибегаю", en: "seek refuge" }, start: 5.53, end: 6.34 },
          { text: "بِكَ", trans: { ru: "к Тебе", en: "with You" }, start: 6.34, end: 6.83 },
          { text: "مِنَ", trans: { ru: "от", en: "from" }, start: 7.44, end: 7.72 },
          { text: "الْخُبُثِ", trans: { ru: "злых духов [мужского пола]", en: "male devils" }, start: 7.72, end: 9.0 },
