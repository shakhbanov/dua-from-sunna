    ...
    duas: [
      ...
      },
      {
        ...
        sync: [
          ...
          { text: "أَشْهَدُ", trans: { ru: "свидетельствую", en: "bear witness" }, start: 0, end: 0 },
          ...
          { text: "رَسُولًا", trans: { ru: "как Посланником", en: "as Messenger" }, start: 0, end: 0 },
      ...
      },
      {
        ...
        sync: [
          ...
          { text: "الدَّعْوَةِ", trans: { ru: "призыва", en: "call" }, start: 0, end: 0 },
          { text: "التَّامَّةِ", trans: { ru: "совершенного", en: "perfect" }, start: 0, end: 0 },
          { text: "وَالصَّلَاةِ", trans: { ru: "и молитвы", en: "and the prayer" }, start: 0, end: 0 },
          { text: "الْقَائِمَةِ", trans: { ru: "совершаемой", en: "about to be established" }, start: 0, end: 0 },
          { text: "آتِ", trans: { ru: "приведи", en: "grant" }, start: 0, end: 0 },
          { text: "مُحَمَّدًا", trans: { ru: "Мухаммада", en: "Muhammad" }, start: 0, end: 0 },
          { text: "الْوَسِيلَةَ", trans: { ru: "к Василе", en: "the Wasilah" }, start: 0, end: 0 },
          { text: "وَالْفَضِيلَةَ", trans: { ru: "и высокому положению", en: "and the eminence" }, start: 0, end: 0 },
          { text: "وَابْعَثْهُ", trans: { ru: "и направь его", en: "and raise him to" }, start: 0, end: 0 },
          { text: "مَقَامًا", trans: { ru: "к месту", en: "the station" }, start: 0, end: 0 },
          { text: "مَحْمُودًا", trans: { ru: "достохвальному", en: "praised" }, start: 0, end: 0 },
          { text: "الَّذِي", trans: { ru: "которое", en: "which" }, start: 0, end: 0 },
          { text: "وَعَدْتَهُ", trans: { ru: "Ты обещал ему", en: "You have promised him" }, start: 0, end: 0 },
          ...
          { text: "الْمِيعَادَ", trans: { ru: "обещаний", en: "the promise" }, start: 0, end: 0 }
        ],
        note: {
