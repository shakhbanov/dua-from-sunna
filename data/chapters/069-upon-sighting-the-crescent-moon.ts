...
export const CHAPTER_069: ChapterData = {
    ...
    duas: [
      {
        id: "69-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/175.wav",
        fullTranslation: {
        ...
        sync: [
          ...
          { text: "أَهِلَّهُ", trans: { ru: "вознеси его", en: "bring it" }, start: 0, end: 0 },
          { text: "عَلَيْنَا", trans: { ru: "над нами", en: "upon us" }, start: 0, end: 0 },
          { text: "بِالْأَمْنِ", trans: { ru: "с безопасностью", en: "with security" }, start: 0, end: 0 },
          { text: "وَالْإِيمَانِ", trans: { ru: "и верой", en: "and faith" }, start: 0, end: 0 },
          { text: "وَالسَّلَامَةِ", trans: { ru: "и избавлением [от бед]", en: "and safety" }, start: 0, end: 0 },
          { text: "وَالْإِسْلَامِ", trans: { ru: "и исламом", en: "and Islam" }, start: 0, end: 0 },
          { text: "وَالتَّوْفِيقِ", trans: { ru: "и содействием", en: "and success" }, start: 0, end: 0 },
          { text: "لِمَا", trans: { ru: "в том, что", en: "in what" }, start: 0, end: 0 },
          { text: "تُحِبُّ", trans: { ru: "Ты любишь", en: "You love" }, start: 0, end: 0 },
          { text: "رَبَّنَا", trans: { ru: "Господь наш", en: "our Lord" }, start: 0, end: 0 },
          { text: "وَتَرْضَىٰ", trans: { ru: "и чем доволен", en: "and are pleased with" }, start: 0, end: 0 },
          { text: "رَبُّنَا", trans: { ru: "Господь наш", en: "Our Lord" }, start: 0, end: 0 },
          { text: "وَرَبُّكَ", trans: { ru: "и Господь твой", en: "and your Lord" }, start: 0, end: 0 },
          { text: "اللَّهُ", trans: { ru: "— Аллах", en: "is Allah" }, start: 0, end: 0 }
        ],
        note: {
