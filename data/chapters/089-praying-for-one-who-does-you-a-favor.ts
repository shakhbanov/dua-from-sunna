...
export const CHAPTER_089: ChapterData = {
    ...
    duas: [
      {
        id: "89-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/dua.shakhbanov.org/dua-from-sunna/198.mp3?v=f3d5abee",
        fullTranslation: {
        ...
        sync: [
          ...
          { text: "خَيْرًا", trans: { ru: "благом", en: "with good" }, start: 2.0, end: 3.44 }
        ],
        note: {
