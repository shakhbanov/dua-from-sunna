...
export const CHAPTER_020: ChapterData = {
    ...
    duas: [
      {
        id: "20-1",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/38.wav",
        fullTranslation: {
      ...
      {
        id: "20-2",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/39.wav",
        fullTranslation: {
      ...
      {
        id: "20-3",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/40.wav",
        fullTranslation: {
