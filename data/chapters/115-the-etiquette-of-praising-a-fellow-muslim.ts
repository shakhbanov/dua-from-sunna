    ...
    duas: [
      {
        ...
        sync: [
          { text: "أَحْسِبُ", trans: { ru: "Я думаю", en: "I reckon" }, start: 0.32, end: 0.92 },
          { text: "فُلَانًا", trans: { ru: "что такой-то", en: "so-and-so" }, start: 0.92, end: 1.98 },
          { text: "وَاللَّهُ", trans: { ru: "но Аллах", en: "but Allah" }, start: 2.63, end: 3.43 },
          { text: "حَسِيبُهُ", trans: { ru: "знает его", en: "is his Reckoner" }, start: 3.43, end: 4.4 },
          { text: "وَلَا", trans: { ru: "и не", en: "and not" }, start: 5.81, end: 5.97 },
          { text: "أُزَكِّي", trans: { ru: "восхваляю я", en: "do I extol" }, start: 5.97, end: 6.65 },
          { text: "عَلَى", trans: { ru: "пред", en: "before" }, start: 6.86, end: 7.28 },
          { text: "اللَّهِ", trans: { ru: "Аллахом", en: "Allah" }, start: 7.28, end: 7.89 },
          { text: "أَحَدًا", trans: { ru: "никого", en: "anyone" }, start: 7.89, end: 8.96 },
          { text: "أَحْسِبُهُ", trans: { ru: "я думаю о нём", en: "I reckon him" }, start: 10.49, end: 11.13 },
          { text: "كَذَا", trans: { ru: "таковым", en: "(to be) such" }, start: 11.13, end: 11.8 },
          { text: "وَكَذَا", trans: { ru: "и таковым", en: "and such" }, start: 11.8, end: 12.58 },
