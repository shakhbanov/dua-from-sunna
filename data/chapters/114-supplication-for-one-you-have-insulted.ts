...
export const CHAPTER_114: ChapterData = {
    ...
    duas: [
      {
        id: "114-1",
        audioUrl: "https://s3.shakhbanov.org/dua-from-sunna/225.wav",
        narration: {
        ...
        sync: [
          ...
          { text: "فَأَيُّمَا", trans: { ru: "какого бы", en: "whichever" }, start: 0, end: 0 },
          { text: "مُؤْمِنٍ", trans: { ru: "верующего", en: "believer" }, start: 0, end: 0 },
          { text: "سَبَبْتُهُ", trans: { ru: "я ни поносил", en: "I reviled" }, start: 0, end: 0 },
          { text: "فَاجْعَلْ", trans: { ru: "сделай", en: "make" }, start: 0, end: 0 },
          { text: "ذَٰلِكَ", trans: { ru: "это", en: "that" }, start: 0, end: 0 },
          { text: "لَهُ", trans: { ru: "для него", en: "for him" }, start: 0, end: 0 },
          { text: "قُرْبَةً", trans: { ru: "средством приближения", en: "a means of nearness" }, start: 0, end: 0 },
