...
export const CHAPTER_064: ChapterData = {
    ...
    duas: [
      {
        id: "64-1",
        audioUrl: "https://s3.twcstorage.ru/44a93b74-shakhbanov/hisn-al-muslim/168.wav",
        fullTranslation: {
        ...
        sync: [
          ...
          { text: "الَّذِي", trans: { ru: "Тот, Кого", en: "the One whom" }, start: 0, end: 0 },
          { text: "يُسَبِّحُ", trans: { ru: "славит", en: "glorifies" }, start: 0, end: 0 },
          { text: "الرَّعْدُ", trans: { ru: "гром", en: "the thunder" }, start: 0, end: 0 },
          { text: "بِحَمْدِهِ", trans: { ru: "хвалой Ему", en: "with His praise" }, start: 0, end: 0 },
          { text: "وَالْمَلَائِكَةُ", trans: { ru: "и ангелы", en: "and the angels" }, start: 0, end: 0 },
          { text: "مِنْ", trans: { ru: "из", en: "out of" }, start: 0, end: 0 },
          { text: "خِيفَتِهِ", trans: { ru: "страха пред Ним", en: "awe of Him" }, start: 0, end: 0 }
        ],
        note: {
